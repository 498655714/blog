            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    ...
                    <div class="position-relative">
                        ...
                        <!--dialog-message-->
                        <div id="dialog-message" class="hide" width="100%" height="100%">
                            一、博客系统概述  （注：协议请您仔细阅读，如有不理解地方请与客服联系：QQ:498655714）  本协议是注册会员协议。
                            “注册会员”是指愿意接受或实际上已经接受本博客系统提供的产品和服务的个人。   此份协议是注册会员接受本博客系统产品和服务时适用的通用条款。
                            因此，请您在注册成为本博客系统会员的注册会员前或接受本博客系统的产品和服务之前，请您详细地阅读本注册会员协议的所有内容。
                            注册会员了解并同意：只要注册会员点击“同意”按钮并完成注册，注册会员就已接受了本注册会员协议及本博客系统公布的各项服务规则（包括填写实名
                            的联系方式等等），并愿意受其约束。如果发生纠纷，注册会员不得以未仔细阅读为由进行抗辩。    注册会员了解并同意：随着市场经营情况的变化，
                            本博客系统有权随时更改本注册会员协议及相关服务规则。修改本注册会员协议时，本博客系统将于相关页面公告修改的事实，有权不对注册会员进行个
                            别通知。注册会员应该在每次登录购买商品前查询本博客系统官方网站的相关公告，以了解本注册会员协议及其他服务规则的变化。若注册会员不同意本
                            注册会员协议或相关服务规则，或者不同意本博客系统作出的修改，注册会员可以主动停止使用本博客系统提供的产品和服务，如果在本博客系统修改协
                            议或服务规则后，注册会员仍继续使用本博客系统提供的产品和服务，即表示注册会员同意本博客系统对本注册会员协议及相关服务规则所做的所有修改
                            。由于注册会员在注册会员协议变更后因未熟悉公告规定而引起的损失，本博客系统将不会承担任何责任。   本博客系统（以下简称本站）的各项电子
                            服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。注册会员必须完全同意所有服务条款并完成注册程序
                            ，才能成为本站的注册会员。注册会员确认：本协议条款是处理双方权利义务的当然约定依据，除非违反国家强制性法律，否则始终有效。在下订单的同
                            时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。

                            二、服务简介  本站运用自己的操作系统通过国际互联网络为注册会员提供网络服务。同时，注册会员必须：  自行配备上网的所需设备，包括个人
                            电脑、调制解调器或其他必备上网装置。  自行负担个人上网所支付的与此服务有关的电话费用、网络费用。  基于本站所提供的网络服务的重要性，
